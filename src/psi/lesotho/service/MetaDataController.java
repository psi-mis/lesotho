...
//    private static String URL_QUERY_LOAD_ATTRIBUTE_GROUPS = Util.LOCATION_DHIS_SERVER + "/api/programSections.json?paging=false&fields=id,name,code,trackedEntityAttributes[id,name,shortName,valueType,optionSet[id,name,options[code,name]]";
